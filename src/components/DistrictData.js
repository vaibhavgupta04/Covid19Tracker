                  ...
                  <tr>
                    ...
                    <td id="confirmed">
                      <div>
                        <span>
                          <NumberFormat
                            value={dist[1].confirmed}
                            displayType={"text"}
                            thousandSeparator={true}
                            thousandsGroupStyle="lakh"
                          />
                        </span>
                        {dist[1].delta.confirmed > 0 && (
                          <span>
                            +
                            <NumberFormat
                              value={dist[1].delta.confirmed}
                              displayType={"text"}
                              thousandSeparator={true}
                              thousandsGroupStyle="lakh"
                            />
                    ...
                    <td id="recovered">
                      <div>
                        <span>
                          <NumberFormat
                            value={dist[1].recovered}
                            displayType={"text"}
                            thousandSeparator={true}
                            thousandsGroupStyle="lakh"
                          />
                        </span>
                        {dist[1].delta.recovered > 0 && (
                          <span>
                            +
                            <NumberFormat
                              value={dist[1].delta.recovered}
                              displayType={"text"}
                              thousandSeparator={true}
                              thousandsGroupStyle="lakh"
                            />
                    ...
                    <td id="deaths">
                      <div>
                        <span>
                          <NumberFormat
                            value={dist[1].deceased}
                            displayType={"text"}
                            thousandSeparator={true}
                            thousandsGroupStyle="lakh"
                          />
                        </span>
                        {dist[1].delta.deceased > 0 && (
                          <span>
                            +
                            <NumberFormat
                              value={dist[1].delta.deceased}
                              displayType={"text"}
                              thousandSeparator={true}
                              thousandsGroupStyle="lakh"
                            />
